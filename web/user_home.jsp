                            ...
                            <div class="col-md-6 offset-md-3">
                                   <div class="card" style="border-radius: 20px;">
                                          <div class="card-header text-center bg-dark text-white" style="border-radius: 10px;">
                                                 <h3><%= userForCurrentPage.getName()%></h3>
                                          </div>
                                          <div class="card-body">
                                                 <div class="container-fluid text-center">
                                                        ...
                                                        <table class="table table-borderless table-striped-columns">
                                                               <tbody>
                                                                      <tr>
                                                                             <th scope="row"><%= userForCurrentPage.getName()%>'s User ID</th>
                                                                             <td><%= userForCurrentPage.getId()%></td> 
                                                                      </tr>                                                   
                                                                      <tr>
                                                                             <th scope="row"><%= userForCurrentPage.getName()%>'s Email</th>
                            ...
                            <div class="col-md-8 offset-md-2">
                                   <div class="card">
                                          <div class="card-header text-center bg-dark text-white">
                                                 <h3>All posts made by <%= userForCurrentPage.getName()%>:</h3>
                                          </div>
                                          <%
